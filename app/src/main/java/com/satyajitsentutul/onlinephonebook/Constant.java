package com.satyajitsentutul.onlinephonebook;
...
public class Constant {
    ...
    public static final String MAIN_URL = "http://android.cseiiuc.cf";  // aei place e Ip dite hobe android.cseiiuc.cf er position e
    ...
    public static final String SHARED_PREF_NAME = "com.satyajitsentutul.onlinephonebook.userlogin"; //pcakage name+ id
